...
understand the ramifications of fixed position in your project; you may need to
add additional CSS.
...
you understand the ramifications of fixed position in your project; you may need
...
Position an element at the bottom of the viewport, from edge to edge, but only
after you scroll past it.

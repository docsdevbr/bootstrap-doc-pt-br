...
- New to browser forms? Consider
  reviewing [the MDN form docs](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/form)
...
and using the `.col-*-*` classes to specify the width of your labels and
controls. Be sure to add `.col-form-label` to your `<label>`s as well so they're
...
Be sure to use `.col-form-label-sm` or `.col-form-label-lg` to your `<label>`s
...
number of `.col`s within a `.row`. They'll split the available width equally

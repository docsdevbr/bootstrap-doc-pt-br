...
control is needed, check out the [textual utility classes]({{< docsref "
/utilities/text" >}}).

- Use a [native font stack]({{< docsref "/content/reboot#native-font-stack" >}})
...
color with our [text utilities]({{< docsref "/utilities/text" >}})
...
the [RFS page]({{< docsref "/getting-started/rfs" >}}) to find out how this
works.
...
Miscellaneous typography elements covered here and in [Reboot]({{< docsref "
/content/reboot" >}}) also have dedicated variables.
...
use [Responsive Font Sizing (RFS)]({{< docsref "/getting-started/rfs" >}}).

...
`margin` by default, so use [spacing utilities]({{< docsref "
/utilities/spacing" >}}) as needed.
...
Use our handful of [available sizing utilities]({{< docsref "
...
specific parts—with our [text align classes]({{< docsref "
...
Bootstrap's [nav components]({{< docsref "/components/navs-tabs" >}}).
...
Use [border utilities]({{< docsref "/utilities/borders" >}}) to change just the
...
Use the Bootstrap grid system and its [`.row-cols` classes]({{< docsref "
/layout/grid#row-columns" >}}) to control how many grid columns (wrapped around
...
a [demo example]({{< docsref "/examples/masonry" >}}) to help you get started.
